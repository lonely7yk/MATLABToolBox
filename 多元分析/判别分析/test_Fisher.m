...
[outclass,TabCan,TabL,TabCon,TabM,TabG] = Fisher(meas,species,x)


%************************绘制两个判别式得分的散点图**************************
% 利用Fisher函数进行判别，返回各种结果，其中ts为判别式得分
[outclass,TabCan,TabL,TabCon,TabM,TabG,ts] = Fisher(meas,species,x);
% 提取各类的判别式得分
...
[outclass,TabCan,TabL,TabCon,TabM,TabG] = Fisher(meas,species,x,0.5)
